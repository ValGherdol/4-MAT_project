            ...
            if methode != D_etapes_names[3] : # Pearson Co-Expression, KNN-RBH or Cluster Path
                if methode == D_etapes_names[4] : L_neig += L_voisins # Cluster Path
                    ...
                    for (n,c) in L_voisins :
                        L_neig.append(n)
                        if methode == D_etapes_names[1] : L_PCEIN.append(n) # Pearson Co-Expression
...
#                  'RICEP':0,'KNN-RBH':0,'NPC-1':0,'NPC-2':0,'NPC-3':0,'CP':0}
        ...
        for m in L_methods :
            if m == D_etapes_names[3] : # NEtwork Properties
        ...
        for name in Set_neig :
            ...
            N_meth = 0
            if (D_etapes_names[1] in L_methods) and (name in L_PCEIN) : # Pearson Co-Expression
                N_meth += 1
